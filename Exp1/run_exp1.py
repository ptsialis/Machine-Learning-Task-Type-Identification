...
exp_df = pd.read_csv("../meta_datasets/tabular_meta_datasets/exp1_train.csv")
...
example_1 = build_example_fewshot_Exp1(
...
example_2 = build_example_fewshot_Exp1(
...
example_3 = build_example_fewshot_Exp1(
...
exp_df_val = pd.read_csv(
    Path("../meta_datasets/tabular_meta_datasets") / split_to_file[args.data]
)
...
if SHOT == "few":
    ...
    system_prompt =  SYSTEM_PROMPT_TEMPLATE_FEW_SHOT_Exp1.format(
        example_1=example_1,
        example_2=example_2,
        example_3=example_3, 
    )
else:
    system_prompt =  SYSTEM_PROMPT_TEMPLATE_ZERO_SHOT_Exp1
...
results_dir = Path("Exp1_Results") / hyperparameter
